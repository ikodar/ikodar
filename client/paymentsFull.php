 ...
 <!--  our   -->
    <div class="container-fluid">
      <div class="card">
        ...
        <!--head line cart-->
          <h4 class="card-title">Fix basis Projects Cart 
      <i class="fa fa-shopping-cart"></i> -<b>
      <?php 
      $eml=$_SESSION['email'];
      $query = "SELECT COUNT(status) FROM projects WHERE status='completed' AND client='$eml' AND payment='full'";
                ...
                <div class="table-responsive">
                    ...
                    <thead class="thead-dark text-primary" >
                          <tr>
                            ...
                            <th width="20px" style="font-size:15px align:left">AMOUNT</th>
      ...
      $query = "SELECT * FROM projects WHERE status='completed' AND client='$eml' AND payment='full'";
